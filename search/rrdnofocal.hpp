...
template <class D> struct RRDNoFocal : public SearchAlgorithm<D> {
	...
	RRDNoFocal(int argc, const char *argv[]) :
	...
	//   }
	  ...
	  if(ss.is_fhat() && bestFHat->fhat <= wt*bestF->f) {
