...
instances = glob("/home/aifs2/group/data/vacuum_instances/uniform/200/200/*/*/*")

command =  "cat {instance} | /home/aifs2/dwr29/search/vacuum/convert_vacex.py | /home/aifs2/dwr29/search/vacuum/vacuum_solver {algorithm} -cost {cost} -wt {subopt} -width {width} > /home/aifs2/dwr29/search/pancake_results/{outfile}" 
            ...
            for weight in alg_weights:
                for aspect in alg_aspects:
                    for inst in instances:
                        ofname = "_".join([algorithm.replace(" ", ""), cost, str(weight), str(width), str("-".join(inst.split("/")[-6:]))])  
